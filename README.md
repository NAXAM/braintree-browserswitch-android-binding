...
# BrainTreeBrowserSwitch for Xamarin.Android

A Xamarin.Android binding library for [BrainTree BrowserSwitch](https://github.com/braintree/browser-switch-android) library.
...
This library is created to be a part of BraintreePayments libraries. It isn't for use for casual case.

If you wanna use/learn it, plz follow the guide from origin repository [here](https://github.com/braintree/browser-switch-android/blob/master/README.md).

## License

BrainTree-BrowserSwitch binding library for Android is released under the MIT license.
